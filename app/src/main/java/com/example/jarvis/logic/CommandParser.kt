...
class CommandParser {
    ...
    private fun parseCommandLogic(cleanText: String): Command {
        ...
        if (cleanText.contains("spotify") && (cleanText.contains("play") || cleanText.contains("put on") || cleanText.contains("start"))) {
            ...
            var query = cleanText
            val seeds = listOf("play", "put on", "start", "on spotify", "in spotify", "spotify", "jarvis")
    ...
    private fun parseReminder(cleanText: String): Command {
        ...
        val fillers = listOf("to", "me", "please", "jarvis", "about", "for")
        fillers.forEach { filler ->
    ...
    private fun normalize(text: String): String {
        ...
        val fillers = listOf("jarvis", "hey", "please", "can you", "could you", "would you", "kindly", "what is", "calculate") 
        fillers.forEach {
